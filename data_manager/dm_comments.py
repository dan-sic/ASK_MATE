...
def add_comment_to_question(cursor, form_data, question_id):
    ...
    cursor.execute("""
                    ...
                    VALUES (0, %(message)s, %(question_id)s, %(time)s)
                    """,
...
def add_comment_to_answer(cursor, form_data, answer_id, question_id):
    ...
    cursor.execute("""
                    ...
                    VALUES (0, %(message)s, %(answer_id)s, %(time)s, %(question_id)s)
                    """,
                   {'message': form_data['message'], 'answer_id': answer_id, 'time': time, 'question_id': question_id})
